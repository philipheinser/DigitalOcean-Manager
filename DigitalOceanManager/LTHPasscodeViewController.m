...
static NSString *const kKeychainPasscode = @"DOPasscode";
static NSString *const kKeychainTimerStart = @"DOPasscodeTimerStart";
static NSString *const kKeychainServiceName = @"DOServiceName";
